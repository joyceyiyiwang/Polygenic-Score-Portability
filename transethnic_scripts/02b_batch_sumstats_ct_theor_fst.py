...
print(paste0("Fst sumstats,",group,",",pheno,",",i,",",beta_maf))
}}
...
Rscript transethnic_scripts/ss_fst_ct_{}_{}.R
rm transethnic_scripts/ss_fst_ct_{}_{}.R
rm transethnic_scripts/ss_fst_ct_{}_{}.sh
"""
...
if __name__ == "__main__":
    ...
    for phenotype in phenotypes:
        for group in groups:
            with open(f'transethnic_scripts/ss_fst_ct_{phenotype}_{group}.R','w') as f:
                f.write(main1(phenotype,group))
            with open(f'transethnic_scripts/ss_fst_ct_{phenotype}_{group}.sh', 'w') as f:
                f.write(main2(phenotype,group))
            os.system(f'sbatch transethnic_scripts/ss_fst_ct_{phenotype}_{group}.sh')
