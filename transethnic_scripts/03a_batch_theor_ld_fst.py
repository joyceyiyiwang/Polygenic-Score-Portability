...
print(paste0("Fst LD,",group,",",rel_r2))
print(group)
print(num)
print(den)
print(rel_r2)
...
Rscript transethnic_scripts/fst_{}1.R
rm transethnic_scripts/fst_{}1.R
rm transethnic_scripts/fst_{}1.sh
"""
...
if __name__ == "__main__":
    groups = [i for i in range(10,31)]
    for group in groups:
        with open(f'transethnic_scripts/fst_{group}1.R','w') as f:
            f.write(main1(group))
        with open(f'transethnic_scripts/fst_{group}1.sh', 'w') as f:
            f.write(main2(group))
        os.system(f'sbatch transethnic_scripts/fst_{group}1.sh')
