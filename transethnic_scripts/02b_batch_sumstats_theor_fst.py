...
print(paste0("Fst sumstats,",group,",",beta_maf))
print(group)
print(num)
print(den)
print(beta_maf)
...
Rscript transethnic_scripts/ss_fst_{}.R
rm transethnic_scripts/ss_fst_{}.R
rm transethnic_scripts/ss_fst_{}.sh
"""
...
if __name__ == "__main__":
    ...
    for group in groups:
        with open(f'transethnic_scripts/ss_fst_{group}.R','w') as f:
            f.write(main1(group))
        with open(f'transethnic_scripts/ss_fst_{group}.sh', 'w') as f:
            f.write(main2(group))
        os.system(f'sbatch transethnic_scripts/ss_fst_{group}.sh')
