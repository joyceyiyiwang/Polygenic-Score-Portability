...
print(paste0("Fst sumstats,",group,",",beta_maf,",",pheno))
print(group)
print(num)
print(den)
print(beta_maf)
...
Rscript transethnic_scripts/ss_fst_{}1.R
rm transethnic_scripts/ss_fst_{}1.R
rm transethnic_scripts/ss_fst_{}1.sh
"""
...
if __name__ == "__main__":
    ...
    for group in groups:
        with open(f'transethnic_scripts/ss_fst_{group}1.R','w') as f:
            f.write(main1(group))
        with open(f'transethnic_scripts/ss_fst_{group}1.sh', 'w') as f:
            f.write(main2(group))
        os.system(f'sbatch transethnic_scripts/ss_fst_{group}1.sh')
