...
Rscript transethnic_scripts/pc_{}.R
rm transethnic_scripts/pc_{}.R
rm transethnic_scripts/pc_{}.sh
"""
...
if __name__ == "__main__":
    ...
    for group in groups:
        with open(f'transethnic_scripts/pc_{group}.R','w') as f:
            f.write(main1(group))
        with open(f'transethnic_scripts/pc_{group}.sh', 'w') as f:
            f.write(main2(group))
        os.system(f'sbatch transethnic_scripts/pc_{group}.sh')
